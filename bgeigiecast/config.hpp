/// @brief User configuration, copied and adapted from bGeigieZen
/// 
...
/** System config (from bGeigieCast/user_config.h) **/
#define ENABLE_DEBUG 1
#define SERIAL_BAUD 115200 /// @todo Is this correct or even needed for Core/Core2?
